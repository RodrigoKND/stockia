...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>
      <Link to="/" className="absolute top-4 left-4 text-neutral-400 hover:text-neutral-600 transition-colors">
      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8" style={{ animation: 'fadeIn 0.6s ease-out' }}>
          ...
          <div className="space-y-4 pt-4">
            {[
              'Detecta y registra tu inventario con IA fácil y rápido',
              'Exporta tus datos',
              'Comparte catálogos con tus clientes'
            ].map((benefit, index) => (
      ...
      <section className="hidden lg:flex flex-1 bg-gradient-to-br from-neutral-100 to-neutral-50 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-2xl">
          <svg viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
            ...
            <text x="400" y="550" textAnchor="middle" fill="#2C3E50" fontSize="24" fontWeight="600" fontFamily="Instrument Sans, sans-serif">
              Preocupaté en lo que si importa
            </text>
          </svg>
        </div>
      </section>
